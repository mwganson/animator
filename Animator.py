...
prop+".A41",prop+".A42",prop+".A43",prop+".A44"]
    ...
    def startAnimating(self, skip_permission = False):
        ...
        if fp.ShowProgress:
            ...
            hideLabel2 = param.GetBool("HideColumn")
            param.SetBool("HideColumn", False)
        ...
        self.isAnimating = False
        param.SetBool("HideColumn", hideLabel2)
...
def makeObject():
    ...
    fp.Proxy.__module__ = "Animator"
    fp.ViewObject.Proxy.__module__ = "Animator"
